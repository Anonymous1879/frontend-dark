...
<div className="flex flex-col min-h-screen w-full font-sans relative overflow-hidden overflow-x-hidden">
  <animated.div
    style={{
      ...
      bottom: 0,
      background:
        "#171717", // Darker gradient background
      backdropFilter: "blur(10px)",
      backgroundSize: "400% 400%",
    }}
  />

  <main className="flex-grow mt-24 px-4 overflow-y-auto overflow-x-hidden relative z-30 pb-24 bg-neutral-900"> {/* Dark background for main content */}
    <animated.div style={fadeIn} className="max-w-1xl mx-auto text-white"> {/* White text for visibility */}
      {showLanding && (
        <div className="flex flex-col min-h-screen w-full font-sans relative overflow-hidden overflow-x-hidden bg-neutral-900">
