...
const Header: React.FC<HeaderProps> = ({ isLoggedIn, onShowSignupForm }) => {
  ...
  return (
    <>
      {showAnnouncement && (
        <div className="bg-gradient-to-r from-gray-800 via-gray-900 to-gray-700 text-white text-center py-2.5 px-4 fixed top-0 left-0 right-0 z-50 border-b border-gray-700">
      ...
      <header 
        className={`fixed left-0 right-0 z-40 bg-gray-900 bg-opacity-80 border-b border-gray-700 ${
